 ...
 */
public class QbRetriveAllUser {
    private QbRetriveUserCallback qbRetriveAllUser;

    public QbRetriveAllUser(QbRetriveUserCallback qbRetriveAllUser) {
        this.qbRetriveAllUser = qbRetriveAllUser;
    }

    public void callForUser(final QBPagedRequestBuilder pagedRequestBuilder) {
        ChatHelper.getInstance().retrieveAllUsersFromPage(pagedRequestBuilder, new QBEntityCallback<ArrayList<QBUser>>() {
            @Override
