 ...
 * @date
 */
public class QbCustomEditTextViewMedium extends EditText {

    public QbCustomEditTextViewMedium(Context context) {
        super(context);
    }

    public QbCustomEditTextViewMedium(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public QbCustomEditTextViewMedium(Context context, AttributeSet attrs, int defStyle) {
